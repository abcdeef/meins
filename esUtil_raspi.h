...
/// \param esContext Application context
//
void ESUTIL_API thread_render(ESContext *esContext);
...
//
int ESUTIL_API esGenCube(float scale, GLfloat **vertices, GLfloat **normals, GLfloat **texCoords, GLubyte **indices);
int ESUTIL_API esGenMesh(int scale, int width, int height, GLfloat **vertices, GLfloat **texCoords, GLuint **indices);
//
